...
//	AxialSymmetry(bool applyOnForce, b2Vec2 pointDepart, b2Vec2 directeur) :pointDepart(pointDepart), directeur(directeur) {};
	AxialSymmetry(bool applyOnForce,bool centeredOnEnnemy, b2Vec2 pointDepart, b2Vec2 directeur):
		Reflection(applyOnForce,centeredOnEnnemy),pointDepart(pointDepart), directeur(directeur) {};
